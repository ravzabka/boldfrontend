...
function bold_files() {
  ...
  wp_enqueue_script('aos-init', get_theme_file_uri('/js/third-part/aos.js'), NULL, '1.0', true);
   ...
   if (strstr($_SERVER['SERVER_NAME'], 'fictional-university.local')) {
    ...
    wp_enqueue_script('our-vendors-js', get_theme_file_uri('/bundled-assets/vendors~scripts.84190b2321b73d2525ac.js'), NULL, '1.0', true);
  
    wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.84190b2321b73d2525ac.js'), NULL, '1.0', true);
   
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.84190b2321b73d2525ac.css'));
    }
